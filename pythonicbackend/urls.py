...
urlpatterns = [
    ...
    path('singledrivervehicle/', views.RentalDriverDates.as_view(), name='all vehicle dates associated with driver'),
    path('validationmessageweek/', views.ValidationComments.as_view(), name='validation messages by week'),
]
