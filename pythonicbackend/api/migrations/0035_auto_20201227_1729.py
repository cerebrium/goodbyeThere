# Generated by Django 3.0.8 on 2020-12-27 17:29
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0034_dailyserviceoverridetwo'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('validationSheet_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ...
                ('support', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='GBP', max_digits=19, null=True, verbose_name='Support')),
                ('miles', models.IntegerField(default=1, null=True, verbose_name='miles')),
                ('totalLwp', models.IntegerField(default=1, null=True, verbose_name='miles')),
                ('totalLVP', models.IntegerField(default=1, null=True, verbose_name='miles')),
                ('totalTraining', models.IntegerField(default=1, null=True, verbose_name='miles')),
            ],
        ),
        migrations.AlterField(
            model_name='invoice',
            name='date',
            field=models.CharField(default=datetime.date(2020, 12, 27), max_length=50, null=True),
        ),
        migrations.AlterField(
            model_name='managers',
            name='creationDate',
            field=models.CharField(default=datetime.date(2020, 12, 27), max_length=50),
        ),
        migrations.AlterField(
