...
class managers(models.Model):
    ...
    DBS3 = models.BooleanField(default=False)
    ...
    DOX2 = models.BooleanField(default=False)
...
class Driver(models.Model):
    ...
    startList = ArrayField(models.CharField(max_length=150), default=list, blank=True)
